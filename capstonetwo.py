...
plt.tight_layout()
st.pyplot(plt.gcf())
revenuetext = st.caption("Over the years, Spotify has achieved remarkable growth in its key revenue streams, including ad revenue, premium revenue, and total revenue. Notably, 2022 marks a pivotal year in the company's financial history, with a substantial 200% increase in total revenue compared to 2017. This robust growth trajectory is mirrored by premium revenue, which has also seen a comparable rate of increase over the same period.")
revenuetext2 = st.caption("Interestingly, ad revenue represents a relatively small portion, accounting for only around 5% of Spotify's total revenue. While it contributes to the company's overall earnings, it's evident that the subscription-based premium model has been the driving force behind Spotify's impressive financial performance in recent years.")
...
plt.tight_layout()
st.pyplot(plt.gcf())
revenuetext = st.caption("Premium revenue has experienced a remarkable surge from 2017 to the present year, 2023. Over this period, it displayed a substantial and consistent growth trajectory. Ad Revenue, on the other hand, exhibits a somewhat fluctuating pattern, with occasional fluctuations that may lead to slight decreases, but overall, it maintains an upward trend.")
revenuetext2 = st.caption("Among the years, 2022 stands out as Spotify's most impressive performance to date. During this period, the company achieved exceptional results, highlighting its ability to generate substantial revenue and establish a strong financial foothold. These insights into Spotify's financial performance provide valuable information about the company's progress and the factors contributing to its success.")
